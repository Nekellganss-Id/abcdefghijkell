...
console.log(color('[•] [ CREATED BY WHY NEKELL🔥 ] [•]'))
console.log(color('Please Follow Me On Sosial Media'))
console.log(color(' ==============================================='))
console.log(color('│ ○ Youtube : https://facebook.com/nekellganss                     '))
console.log(color('│ ○ Instagram : https://instagram.com/nekellgatau                 '))
console.log(color('│ ○ Tiktok : https://tiktok.com/@abcdefghijkell                        '))
console.log(color('│ ○ Github : https://github.com/Nekellganss-Id                        '))
console.log(color(' ==============================================='))
zero.on('qr', () => {
...
zero.sendMessage(anu.jid, "=|HAY IDOLL!.. SAYA NEKELL🔥 SAYA AKAN MEMBANTU,MEMPERMUDAH KINERJA WHATSAPP SEPERTI MEMBUAT STICKER DAN LAIN LAIN YANG ADA DI DALAM FITUR. |=", "conversation")
}
...
sendButImage(anu.jid, teks, `©Created By Why Nekell?🔥`, img,but = [{buttonId:`hallo`, 
...
sendButImage(anu.jid, teks, `©Created By Why Nekell?🔥`, img,but= [{buttonId: `byebye`, buttonText: {displayText: `YAHAHA BEBAN OUT!!!`}, type: 1}], options = {contextInfo: {mentionedJid: [num, number]}, thumbnail: Buffer.alloc(0)})
}
